...
<html>
  <head>
    ...
    <title> Gran Manzana | Leer Correo</title>
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li><a href="mailbox.html"><i class="fa fa-inbox"></i> Buzón <span class="label label-primary pull-right">4</span></a></li>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                  <div class="mailbox-read-info">
                    ...
                    <h5>From: info@granmanzana.es <span class="mailbox-read-time pull-right">15 Feb. 2015 11:03 PM</span></h5>
                ...
                <div class="box-footer">
                  <div class="pull-right">
                    ...
                    <button class="btn btn-default"><i class="fa fa-share"></i> Reenviar </button>
                  </div>
