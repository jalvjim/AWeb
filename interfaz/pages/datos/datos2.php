                            ...
                            <form role="form">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="nombre" class="form-control" id="exampleInputEmail1" placeholder="Apellidos">
                                    </div>
                                    <!-- Email -->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="telefono1" placeholder="Teléfono 1">
                                    </div>

                                    <!-- Telefono -->
                                    <div class="form-group">
                                        <label for="telefono2">Telefono 2</label>
                                        <input type="text" class="form-control" id="telefono2" placeholder="Teléfono 2">
                                    </div>
                                    ...
                                    <!-- CP -->
                                    <span class="text-red">Opcion 2</span>
                                    <div class="form-group">
                                        <label>C.P</label>
                        ...
                        <div class="box box-info">
                            ...
                            <form class="form-horizontal">
                              <div class="box-body">
                                ...
                                <div class="form-group">
                                  <div class="col-sm-10">
                                    <input type="password" class="form-control" id="inputPassword2" placeholder="Nueva contraseña">
                                  </div>
                                </div>
